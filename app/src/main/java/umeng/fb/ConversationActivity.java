...
public class ConversationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			replyListView = (ListView) findViewById(R.id
                    .umeng_fb_reply_list);
			...
			// contact info entry
			View contact_entry = findViewById(R.id
                    .umeng_fb_conversation_contact_entry);
				...
				public void onClick(View v) {
					...
					if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.DONUT) {
						overridePendingTransition(
                                R.anim
                                        .umeng_fb_slide_in_from_right,
                                R.anim
                                        .umeng_fb_slide_out_from_left
                        );
					}
				}
			...
			userReplyContentEdit = (EditText) findViewById(R.id
                    .umeng_fb_reply_content);
